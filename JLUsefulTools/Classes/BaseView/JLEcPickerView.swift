...
public protocol HorizontalMultiPickerViewDelegate: AnyObject {
    func multiPickerView(_ pickerView: JLEcPickerView, didConfirmSelection selections: [Int])
    func multiPickerView(_ pickerView: JLEcPickerView, didChangeSelection selections: [Int])
}

open class JLEcPickerView: UIView {
    ...
    public var confirmButtonConfig: (title: String, color: UIColor) = ("确定", .systemBlue) {
    ...
    private func setupMagnifier() {
        ...
        magnifier.backgroundColor = UIColor.white
...
extension JLEcPickerView: UIPickerViewDataSource, UIPickerViewDelegate {
...
extension JLEcPickerView: UIScrollViewDelegate {
