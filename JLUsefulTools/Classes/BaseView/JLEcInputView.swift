...
open class JLEcInputView: JLEcBaseView {
    // 左侧标题
    ...
    // 公开的输入内容 Observable
    open var textObservable: RxSwift.Observable<String> {
    ...
    /// 配置输入框的标题
    open func configure(title: String, placeholder: String, _ text: String? = nil) {
    ...
    private func setupKeyboardHandling() {
        guard let scene = UIApplication.shared.keyWindow else { return }
