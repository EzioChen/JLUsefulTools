...
open class JLEcAlertInputView {
    ...
    public static func showSingleInput(
        title: String?,
        message: String?,
    ...
    public static func showMultipleInputs(
        title: String?,
        message: String?,
        inputs: [InputConfig],
        confirmTitle: String = "确定",
    ...
    ///   - validation: 输入验证闭包
    ///   - completion: 完成回调
    public static func showValidatedInput(
        title: String?,
        message: String?,
        placeholder: String? = nil,
        keyboardType: UIKeyboardType = .default,
